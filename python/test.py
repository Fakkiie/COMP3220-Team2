...
class ServiceRequest:
    ...
    def write_to_json(self, data, output_file="grouped_requests.json"):
        try:
...
if __name__ == "__main__":
    ...
    if grouped_requests is not None:
        print(json.dumps(grouped_requests, indent=4))  # Print the grouped data to verify
        # Write the grouped data to a JSON file
        service_processor.write_to_json(grouped_requests, "grouped_requests.json")
